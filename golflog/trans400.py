...
def main():
    ...
    #count_graph = construct(graphs, "1" *(33-1) +"0", B0, B1)
    ...
    # 00111 を仮変数置場にする
    part2_state = new_state_set(graphs, '00111', '1'*(8*1+1), B0, B1)
    ...
    next_state(graphs, cur_state2, copy_state)
    ...
    #isendable_state = new_state_if(graphs, '000', '0001'+ '0', ending_state, B0, B1)
    isendable_state = new_state_if(graphs, '001', '0001'+ '0', graphs[root][1], B0, B1)
    ...
    next_state(graphs, isendable_state, ending_state)
