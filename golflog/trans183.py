...
def main():
    ...
    next_state(graphs, part5_state, copy_5_cur_state)
    next_state(graphs, copy_5_cur_state, copy5_state)
    #cur_state2 = new_state_set(graphs, '1', '1'*29, B0, B1)
# cur_state と cur_state2 の内容は同じ -> なので引数部分のノード共通化できる
    ...
    next_state(graphs, copy5_state, cur_state2)
    ...
    isendable_state = new_state_if(graphs, '000', '111', ending_state, B0, B1)
